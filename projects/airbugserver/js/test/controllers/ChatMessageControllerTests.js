...
var chatMessageControllerInstantiationTest = {
    ...
    test: function(test) {
        ...
        test.assertEqual(this.chatMessageController.expressApp, this.expressApp,
            "Assert expressApp has been set to chatMessageController's expressApp property");
        test.assertEqual(this.chatMessageController.bugCallRouter, this.bugCallRouter,
            "Assert bugCallRouter has been set to chatMessageController's expressApp property");
        test.assertEqual(this.chatMessageController.chatMessageService, this.chatMessageService,
