...
require('bugpack').context("*", function(bugpack) {
    ...
    var RoomService = Class.extend(EntityService, {
        ...
        _name: "airbugserver.RoomService",
         ...
         * @param {ChatMessageStreamManager} chatMessageStreamManager
         * @param {RoomPusher} roomPusher
                                ...
                                if (!returnedRoomMap) {
                                    ...
                                    returnedRoomMap.forEach(function(room, key) {
                                        if (room === null) {
                                            ...
                                            mappedException.putCause(key, new Exception("NotFound", {objectId: key}, "Could not find room by the id '" + key + "'"));
                                        }
                                    });
                                }
                            }
