...
//@Export('SaveImageNakedButtonContainer')
...
var SaveImageNakedButtonContainer = Class.extend(CarapaceContainer, {
    ...
    hearButtonClickedEvent: function(event) {
        this.buttonView.dispatchEvent(new ImageViewEvent(ImageViewEvent.EventType.CLICKED_SAVE, {}));
    }
});
...
bugpack.export("airbug.SaveImageNakedButtonContainer", SaveImageNakedButtonContainer);
