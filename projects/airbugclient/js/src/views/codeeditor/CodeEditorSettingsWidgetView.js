...
require('bugpack').context("*", function(bugpack) {
     ...
     * @extends {BoxView}
     */
    var CodeEditorSettingsWidgetView = Class.extend(BoxView, {
        ...
        template:
            '<div id="code-editor-settings-widget-{{cid}}" class="workspace-widget box box-with-header {{classes}}">\
                <div id="box-header-{{cid}}" class="box-header workspace-widget-header">\
                </div>\
                <div id="box-body-{{cid}}" class="box-body">\
                    <div class="code-editor-settings">\
