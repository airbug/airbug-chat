...
//@Export('airbug.TwoRowView')

//@Require('Class')
//@Require('TypeUtil')
//@Require('airbug.MultiRowView')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var MultiRowView        = bugpack.require('airbug.MultiRowView');
    ...
    bugpack.export("airbug.TwoRowView", TwoRowView);
});
