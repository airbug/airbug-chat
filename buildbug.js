...
buildProperties({
    ...
    client: {
        ...
        sourcePaths: [
            ...
            "../bugcall/libraries/client/js/src",
    ...
    server: {
        ...
        sourcePaths: [
            ...
            "../bugcall/libraries/server/js/src",
            "../bugcontroller/libraries/bugcontroller/js/src",
            "../bugcore/libraries/bugcore/js/src",
            "../bugdelta/libraries/bugdelta/js/src",
            "../bugentity/libraries/bugentity/js/src",
        ...
        unitTest: {
            ...
            testPaths: [
                ...
                "../bugcall/libraries/server/js/test",
                "../bugcontroller/libraries/bugcontroller/js/test",
                "../bugcore/libraries/bugcore/js/test",
                "../bugdelta/libraries/bugdelta/js/test",
                "../bugentity/libraries/bugentity/js/test",
