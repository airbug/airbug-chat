...
//@Export('airbug.ModalView')

//@Require('Class')
//@Require('airbug.ButtonViewEvent')
//@Require('airbug.ModalViewEvent')
...
require('bugpack').context("*", function(bugpack) {
    ...
    var ModalViewEvent      = bugpack.require('airbug.ModalViewEvent');
    ...
    bugpack.export("airbug.ModalView", ModalView);
});
