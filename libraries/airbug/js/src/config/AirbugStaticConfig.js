...
//@Export('airbug.AirbugStaticConfig')
...
require('bugpack').context("*", function(bugpack) {
     ...
     * @extends {Config}
     */
    var AirbugStaticConfig = Class.extend(Config, {

        _name: "airbug.AirbugStaticConfig",
    ...
    bugpack.export("airbug.AirbugStaticConfig", AirbugStaticConfig);
});
